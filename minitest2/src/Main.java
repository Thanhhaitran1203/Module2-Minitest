...
public class Main {
    ...
    ProgrammingBook b2 = new ProgrammingBook (2,"book2",20,"b","Java","b");
    ProgrammingBook b3 = new ProgrammingBook (3,"book3",30,"c","C","c");
    ProgrammingBook b4 = new ProgrammingBook (4,"book4",40,"d","C#","d");
    ProgrammingBook b5 = new ProgrammingBook (5,"book5",50,"e",".Net","e");
    FictionBook b6 = new FictionBook (6,"book6",60,"f","Viễn tưởng 1");
    FictionBook b7 = new FictionBook (7,"book6",70,"f","Viễn tưởng 2");
    FictionBook b8 = new FictionBook (8,"book6",80,"f","Viễn tưởng 3");
    FictionBook b9 = new FictionBook (9,"book6",90,"f","Viễn tưởng 4");
    FictionBook b10 = new FictionBook (10,"book6",100,"f","Viễn tưởng 5");
    ...
    public static int countJavaBook(Book[][] arr){
        ...
        for (Book[] i: arr) {
            if (i instanceof ProgrammingBook[]) {
                for (Book j : i) {
                    ProgrammingBook proBook = (ProgrammingBook) j;
